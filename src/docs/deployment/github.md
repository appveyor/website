...
The permissions `repo:status`, `repo_deployment` are necessary for successful deployment of artifacts to GtiHub.
 Be sure to encrypt your token using "Encrypt configuration data" page in AppVeyor (**Account** &rarr; **Encrypt YAML**).
