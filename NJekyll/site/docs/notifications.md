...
![email notifications](/content/docs/images/notifications/email-notifications.png)
...
![hipchat-build-passed-api-v1](/content/docs/images/notifications/hipchat-build-passed-api-v1.png)

![hipchat-build-failed-api-v1](/content/docs/images/notifications/hipchat-build-failed-api-v1.png)

while API v2 always sends messages on behalf API token issuer:

![hipchat-build-passed-api-v2](/content/docs/images/notifications/hipchat-build-passed-api-v2.png)

![hipchat-build-failed-api-v2](/content/docs/images/notifications/hipchat-build-failed-api-v2.png)
...
![slack-build](/content/docs/images/notifications/slack-build.png)
